                                            ...
                                            <template v-for="(row, index) in fields" >
                                                <tr :key="'row' + index">
                                                    <template v-for="aField in row.cols">
                                                        <td v-if="aField.isSet" class="char-pic field" :key="aField">
                                                            <div v-if="aField.colour && this.playerListBufferBlue !== 0" >
                                                                <input class="fig-cards blue" type="image"  :src="aField.figSrc" alt=""/>
                                                            </div>
                                                            <div v-else-if="!aField.colour && this.playerListBufferRed !== 0">
                                                                <input class="fig-cards red" type="image"  :src="aField.figSrc" alt=""/>
                                                            </div>
                                                            <div v-else-if="this.playerListBufferBlue === 0 && aField.colour">
                                                                <input class="fig-cards" type="image"  :src="aField.blueSrc" alt="blue"/>
                                                            </div>
                                                            <div v-else-if="this.playerListBufferRed === 0 && !aField.colour">
                                                                <input class="fig-cards" type="image"  :src="aField.redSrc" alt="red"/>
                                                            </div>
                                                        </td>
